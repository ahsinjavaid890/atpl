                ...
                <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover nav-line-active">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-md-5">
                            ...
                            <li class="nav-item dropdown {{ request()->path() == 'services' ? 'active':''}}">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)">{{ __('Services') }}</a>
                                <ul class="dropdown-menu">
                                    @foreach($services as $data)
                                    <li><a class="dropdown-item" href="{{ url('service') }}/{{ $data->slug }}">{{ $data->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
                            <li class="nav-item dropdown {{ request()->path() == 'products' ? 'active':''}}">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)">{{ __('Products') }}</a>
                                <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown ">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('front.page',$data->slug) }}">{{ $data->title }}</a></li>
                                    @endforeach
                                </ul>
                            </li>
