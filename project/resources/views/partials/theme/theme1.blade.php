                ...
                <div class="container">
                    <div class="banner-wrapper-item text-{{ $data->position }}">
                        <div class="banner-content text-dark ">
                            ...
                            <h2 style="color: {{ $data->title_color  }} !important;" class="title text-dark slide-h5">{{$data->title_text}}</h2>

                            <p style="color: {{ $data->details_color  }} !important;" class="slide-h5">{{$data->details_text}}</p>

                            <a href="{{$data->link}}" class="cmn--btn ">{{$data->btn_text}}</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="product type-product">
                    <div class="product-wrapper">
                        <div class="product-image">
                            <a href="{{route('front.category',$fcategory->slug)}}"><img src="{{asset('assets/images/categories/'.$fcategory->image)}}" alt="Product image"></a>
                        </div>
                        <div class="product-info">
                            <h6 class="product-title"><a href="{{route('front.category',$fcategory->slug)}}">{{$fcategory->name}}</a></h6>
                        </div>
                    </div>
                </div>
            </div>
