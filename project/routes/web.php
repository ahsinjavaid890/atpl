...
// ************************************ USER SECTION **********************************************
    ...
    Route::prefix('user')->group(function () {
        ...
        //2checkout Routes
        Route::post('/api/twocheckout-submit', 'Api\User\Payment\TwoCheckoutController@store')->name('api.user.deposit.twocheckout.submit');
...
// ************************************ FRONT SECTION **********************************************
    Route::get('/service/{id}', 'Front\FrontendController@servicedetails');
