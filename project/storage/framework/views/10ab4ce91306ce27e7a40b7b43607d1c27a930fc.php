...
<!--         <span class="nextBtn"></span>
        ...
        <div class="getquoteformbox" style="position:absolute;right: 19px;background-color: white;z-index: 10;width: 400px;padding: 20px;top: 20%;right: 10%;border-radius: 5px;">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" style="border: 1px solid #ddd;" name="">
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea style="border: 1px solid #ddd;" rows="5" class="form-control" ></textarea>
                    </div>
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-12">
                    <div class="form-group">
                        <input type="submit" class="cmn--btn" name="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="container">
                    <div class="banner-wrapper-item text-<?php echo e($data->position); ?>">
                        <div class="banner-content text-dark ">
                            ...
                            <h2 style="color: <?php echo e($data->title_color); ?> !important;" class="title text-dark slide-h5"><?php echo e($data->title_text); ?></h2>

                            <p style="color: <?php echo e($data->details_color); ?> !important;" class="slide-h5"><?php echo e($data->details_text); ?></p>

                            <a href="<?php echo e($data->link); ?>" class="cmn--btn "><?php echo e($data->btn_text); ?></a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\aweentechnologies\project\resources\views/partials/theme/theme1.blade.php ENDPATH**/ ?>