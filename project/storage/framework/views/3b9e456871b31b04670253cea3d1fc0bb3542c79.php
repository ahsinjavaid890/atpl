<script>
                                        ...
                                        '<div  class="row">'+
                                            '<div class="col-md-3 col-sm-6">'+
                                                ...
                                                '<?php echo e(__("Size Name")); ?> :'+
                                                    '<span><?php echo e(__("(eg. S,M,L,XL,3XL,4XL)")); ?></span>'+
                                                '</label>'+
                                            ...
                                            '<div class="col-md-3 col-sm-6">'+
                                                ...
                                                '<span><?php echo e(__("(Quantity of this size)")); ?></span>'+
                                                '</label>'+
                                                '<input type="number" name="size_qty[]" required class="input-field" placeholder="<?php echo e(__("Size Qty")); ?>" value="1" min="1">'+
                                            '</div>'+
                                            '<div class="col-md-3 col-sm-6">'+
                                                '<label>'+
                                                '<?php echo e(__("Size Price")); ?> :'+
                                                '<span><?php echo e(__("(Added with base price)")); ?></span>'+
                                                '</label>'+
                                                '<input type="number" name="size_price[]" required class="input-field" placeholder="<?php echo e(__("Size Price")); ?>" value="0" min="0">'+
                                            '</div>'+
                                            '<div class="col-md-3 col-sm-6">'+
                                                '<label>'+
    ...
    $("#tsize-section").append(
                                '<div class="tsize-area">'+
                                    ...
                                    '<input  type="text" class="input-field tsize" name="size_all[]" placeholder="<?php echo e(__("Enter Product Size")); ?>"  required="">'+
                                '</div>'
                            );
    ...
    $("#tsize-section").append(
                                '<div class="tsize-area">'+
                                    '<span class="remove tsize-remove"><i class="fas fa-times"></i></span>'+
                                    '<input  type="text" class="input-field tsize" placeholder="<?php echo e(__("Enter Product Size")); ?>"  required="">'+
                                '</div>'
                                );
                                ...
                                '<div class="license-area">'+
                                    '<span class="remove license-remove"><i class="fas fa-times"></i></span>'+
                                        '<div  class="row">'+
                                            ...
                                            '</div>'+
                                            '<div class="col-lg-6">'+
                                                '<input type="number" name="license_qty[]" min="1" class="input-field" placeholder="<?php echo e(__("License Quantity")); ?>" value="1">'+
                                            '</div>'+
                                        '</div>'+
                                '</div>'
                                +'');
    ...
    </script><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/partials/admin/product/product-scripts.blade.php ENDPATH**/ ?>