                    ...
                    <div class="product-description">
                      ...
                      <?php echo $__env->make('alerts.admin.form-both', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                            <div class="left-area">
                                <h4 class="heading"><?php echo e(__('Btn Text')); ?> *</h4>
                            </div>
                          </div>
                          <div class="col-lg-7">
                            <input type="text" class="input-field" name="btn_text" placeholder="Btn Text" required="" value="<?php echo e($data->btn_text); ?>">
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select  name="position" required="">
                                  ...
                                  <option value="left" <?php echo e($data->position == 'left' ? 'selected':''); ?>><?php echo e(__('Left')); ?></option>
                                  <option value="center" <?php echo e($data->position  == 'center' ? 'selected':''); ?>><?php echo e(__('Center')); ?></option>
                                  <option value="right" <?php echo e($data->position  == 'right' ? 'selected':''); ?>><?php echo e(__('Right')); ?></option>
                                </select>
                          </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/admin/slider/edit.blade.php ENDPATH**/ ?>