 ...
 <header class="ecommerce-header px-lg-5">
   <div style="display: none !important;" class="top-header d-none d-lg-block py-2 border-0 font-400">
          ...
          <div class="row align-items-center">
              ...
              <div class="col-lg-8 d-flex">
                  <ul class="top-links d-flex ms-auto align-items-center">
                        ...
                        <?php if(App\Models\Language::count() != 1): ?>
                ...
                <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover nav-line-active">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-md-5">
                            ...
                            <li class="nav-item dropdown <?php echo e(request()->path() == 'services' ? 'active':''); ?>">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"><?php echo e(__('Services')); ?></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(url('service')); ?>/<?php echo e($data->slug); ?>"><?php echo e($data->title); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </li>
                            <li class="nav-item dropdown <?php echo e(request()->path() == 'products' ? 'active':''); ?>">
                                <a class="nav-link dropdown-toggle" href="javascript:void(0)"><?php echo e(__('Products')); ?></a>
                                <ul class="dropdown-menu">
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><a class="dropdown-item" href="<?php echo e(url('category')); ?>/<?php echo e($category->slug); ?>"><?php echo e($category->name); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </li>
                            ...
                            <li class="nav-item dropdown ">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a class="dropdown-item" href="<?php echo e(route('front.page',$data->slug)); ?>"><?php echo e($data->title); ?></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </li>
...
<!--==================== Header Section End ====================-->
<?php /**PATH D:\xamp\htdocs\aweentechnologies\project\resources\views/partials/global/common-header.blade.php ENDPATH**/ ?>