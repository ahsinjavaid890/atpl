...
<?php $__env->startSection('content'); ?>  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading"><?php echo e(__("Affiliate Products")); ?></h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="<?php echo e(route('admin-prod-index')); ?>"><?php echo e(__("Affiliate Products")); ?></a>
											</li>
										</ul>
								</div>
							</div>
...
(function($) {
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '<?php echo e(route('admin-import-datatables')); ?>',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="<?php echo e(route('admin-import-create')); ?>">'+
...
<?php $__env->stopSection(); ?>   
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/admin/productimport/index.blade.php ENDPATH**/ ?>