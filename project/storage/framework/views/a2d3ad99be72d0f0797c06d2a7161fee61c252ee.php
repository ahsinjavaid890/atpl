...
<?php $__env->startSection('content'); ?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e(__("Digital Product")); ?> <a class="add-btn" href="<?php echo e(route('admin-prod-types')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__("Back")); ?></a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="<?php echo e(route('admin-prod-create','digital')); ?>"><?php echo e(__("Digital Product")); ?></a>
												</li>
											</ul>
									</div>
								</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/admin/product/create/digital.blade.php ENDPATH**/ ?>