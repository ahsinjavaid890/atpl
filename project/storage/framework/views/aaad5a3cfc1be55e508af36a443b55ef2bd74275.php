                        ...
                        <form id="geniusformdata" action="<?php echo e(route('admin-cat-create')); ?>" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="row">
                              <div class="col-lg-4">
                                <div class="left-area">
                                  <h4 class="heading"><?php echo e(__('Set Image')); ?> *</h4>
                                </div>
                              </div>
                              <div class="col-lg-7">
...
<?php echo $__env->make('layouts.load', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/admin/category/create.blade.php ENDPATH**/ ?>