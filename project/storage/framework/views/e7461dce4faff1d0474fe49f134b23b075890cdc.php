...
<?php if ($__env->exists('partials.global.common-header')) echo $__env->make('partials.global.common-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- breadcrumb -->
<div class="full-row bg-light overlay-dark py-5" style="background-image: url(<?php echo e($gs->breadcrumb_banner ? asset('assets/images/'.$gs->breadcrumb_banner):asset('assets/images/noimage.png')); ?>); background-position: center center; background-size: cover;">
   <div class="container">
      <div class="row text-center text-white">
         <div class="col-12">
            <h3 class="mb-2 text-white"><?php echo e(__('Product')); ?></h3>
         </div>
         <div class="col-12">
...
<div class="full-row">
   <div class="container">
      <div class="row">
         <?php if ($__env->exists('partials.catalog.catalog')) echo $__env->make('partials.catalog.catalog', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         ...
         <div class="col-xl-9">
            ...
            <?php if ($__env->exists('frontend.category')) echo $__env->make('frontend.category', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <div class="showing-products pt-30 pb-50 border-2 border-bottom border-light" id="ajaxContent">
               <?php if ($__env->exists('partials.product.product-different-view')) echo $__env->make('partials.product.product-different-view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
            <?php echo $__env->make('frontend.pagination.product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
         </div>
         <?php else: ?>
         <div class="col-lg-9">
            <div class="card">
...
<script>
   ...
   if ($("#pageby").val() != '') {
     if (filterlink == '') {
       filterlink += '<?php echo e(route('front.category', [Request::route('category'), Request::route('subcategory'), Request::route('childcategory')])); ?>' + '?'+$("#pageby").attr('name')+'='+$("#pageby").val();
     } else {
   ...
   $('ul.pagination li a').each(function() {
     ...
     let fullUrl = '<?php echo e(route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')])); ?>?page='+page+'&search='+'<?php echo e(urlencode(request()->input('search'))); ?>';
...
<script type="text/javascript">
   (function($) {
     ...
     $(function () {
       ...
       min: <?php echo e($gs->min_price); ?>,
       max: <?php echo e($gs->max_price); ?>,
       values: [<?php echo e(isset($_GET['min']) ? $_GET['min'] : $gs->min_price); ?>, <?php echo e(isset($_GET['max']) ? $_GET['max'] : $gs->max_price); ?>],
       step: 1,
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xamp\htdocs\atpl\project\resources\views/frontend/products.blade.php ENDPATH**/ ?>